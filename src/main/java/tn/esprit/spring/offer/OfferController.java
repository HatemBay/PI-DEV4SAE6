...
public class OfferController {
	...
	@GetMapping("/offer/get-fav-user/{id}")
	public List<OfferFav> getOfferFavPerUser(@PathVariable int id){
		return sf.getOfferFavPerUser(id);
	}
	
	@GetMapping("/offer/get-per-user/{id}")
	public List<Offer> getOfferPerUser(@PathVariable int id){
		return ss.getOfferPerUser(id);
	}
	
	@GetMapping("/sellers/get-per-user/{id}")
	public List<Offer> getOfferPerSeller(@PathVariable int id){
		return ss.getOfferPerSeller(id);
	}
